...
│ ├── canvas.html # Real-time collaborative canvas
│ ├── ecommerce.html # E-commerce with offline mode
│ ├── media-player.html # Advanced media player
│ └── dashboard.html # Live data dashboard
│
├── blog/ # Blog posts
│ ├── release-0.1.0.html # v0.1.0 release notes
│ ├── release-0.2.0.html # v0.2.0 release notes
│ ├── roadmap-2024.html # Roadmap
│ └── why-flaxon.html # Philosophy article
│
...
│ │ └── examples.css # Interactive examples styles
│ │
│ ├── js/
...
│ └── blog-posts.json
│
├── CNAME # Custom domain (flaxon.dev)
